...
void SZx_compute_derivative_diff_2dblock(
    ...
    double *dx_result, double *dy_result, double errorBound
){
...
void SZx_derivative_diff_kernel_2dblock(
    ...
    SZx_compute_derivative_diff_2dblock(cmpData, block_dim1, block_dim2, blockSideLength, blocks_quant_mean.data(), offsets, fixedRate,
...
void SZx_derivative_quant_kernel_2dblock(
    ...
    int * currBlockRow = (int *)calloc(blockSize * block_dim2, sizeof(int));
    int * nextBlockRow = (int *)calloc(blockSize * block_dim2, sizeof(int));
    SZx_compute_derivative_quant_2dblock(cmpData, block_dim1, block_dim2, blockSideLength, blocks_quant_mean.data(), offsets, fixedRate,
                                         absQuantDiff, signFlag, prevBlockRow, currBlockRow, nextBlockRow, dx_result, dy_result, errorBound);
    free(prevBlockRow);
    free(currBlockRow);
    free(nextBlockRow);
