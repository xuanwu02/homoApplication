...
int main(int argc, char **argv)
{
    ...
    switch(stateType){
        ...
        case 1:{
            SZp_decompress_prePred(intData, cmpData, dim1, dim2, dim3, blockSideLength, eb);
            break;
        }
        case 2:{
            SZp_decompress_postPred(intData, cmpData, dim1, dim2, dim3, blockSideLength, eb);
            break;
        }
        case 4:{
            SZp_decompress_fast(decData, cmpData, dim1, dim2, dim3, blockSideLength, eb);
            break;
        }
    }
    ...
    double err = verify(oriData, decData, dim1, dim2, dim3);
    printf("err = %.6e\n", err);
