...
int main(int argc, char **argv)
{
    ...
    switch(stateType){
        ...
        case 1:{
            SZx_decompress_prePred(intData, cmpData, dim1, dim2, blockSideLength, eb);
            break;
        }
        case 2:{
            SZx_decompress_postPred(intData, cmpData, dim1, dim2, blockSideLength, eb);
            break;
        }
        case 3:{
            SZx_decompress_meta(intData, cmpData, dim1, dim2, blockSideLength, eb);
            break;
        }
    }
