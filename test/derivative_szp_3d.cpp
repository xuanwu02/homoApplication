...
int main(int argc, char **argv)
{
    ...
    size_t cmpSize = 0;
    SZp_compress_3dLorenzo(oriData, cmpData, dim1, dim2, dim3, blockSideLength, eb, cmpSize);
    printf("cr = %.2f\n", 1.0 * nbEle * sizeof(T) / cmpSize);

    SZp_dxdydz_3dLorenzo(cmpData, dim1, dim2, dim3, blockSideLength, eb, dx_result, dy_result, dz_result, intToDecmpState(stateType));

    SZp_decompress_3dLorenzo(decData, cmpData, dim1, dim2, dim3, blockSideLength, eb);
