...
int main(int argc, char **argv)
{
    ...
    switch(bufferType){
        case 0:{
            SZx_dxdydz_3dMeanbased_IntBuffer(cmpData, dim1, dim2, dim3, blockSideLength, eb, dx_result, dy_result, dz_result, intToDecmpState(stateType));
            break;
        }
        case 1:{
            SZx_dxdydz_3dMeanbased_FltBuffer(cmpData, dim1, dim2, dim3, blockSideLength, eb, dx_result, dy_result, dz_result, intToDecmpState(stateType));
            break;
        }
        default:
            break;
