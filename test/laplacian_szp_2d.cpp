...
int main(int argc, char **argv)
{
    ...
    switch(bufferType){
        case 0:{
            SZp_laplacian_2dLorenzo_IntBuffer(cmpData, dim1, dim2, blockSideLength, eb, laplacian_result, intToDecmpState(stateType));
            break;
        }
        case 1:{
            SZp_laplacian_2dLorenzo_FltBuffer(cmpData, dim1, dim2, blockSideLength, eb, laplacian_result, intToDecmpState(stateType));
            break;
        }
        default:
            break;
