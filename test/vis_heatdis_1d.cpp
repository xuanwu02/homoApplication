...
int main(int argc, char **argv)
{
    ...
    SZp_heatdis_1dLorenzo<T>(cmpData, s.dim1, s.dim2, s.B, s.steps, cmpSize, s.src_temp, s.wall_temp, s.init_temp, s.ratio, s.eb, decmpState::full, true);
    SZp_heatdis_1dLorenzo<T>(cmpData, s.dim1, s.dim2, s.B, s.steps, cmpSize, s.src_temp, s.wall_temp, s.init_temp, s.ratio, s.eb, decmpState::prePred, true);
    SZp_heatdis_1dLorenzo<T>(cmpData, s.dim1, s.dim2, s.B, s.steps, cmpSize, s.src_temp, s.wall_temp, s.init_temp, s.ratio, s.eb, decmpState::postPred, true);
